...
Name "Joystick Plugin ${VERSION} for CryEngine"

; The file to write
OutFile "Plugin_Joystick_${VERSION}.exe"
...
; Sections
Section "Joystick" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\Joystick"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\Joystick\Plugin_Joystick.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\Joystick\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\Joystick"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\Joystick\Plugin_Joystick.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\Joystick\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_Joystick"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_Joystick\inc"
...
; Set Fileinfos
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "Joystick Plugin"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2012, The authors of the Joystick Plugin project"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "Joystick Plugin for CryEngine"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_Joystick\changelog.md"'
FunctionEnd
